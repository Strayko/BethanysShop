...
namespace BethanysShop.Migrations
{
    ...
    [Migration("20200119100044_OrdersAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BethanysShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BethanysShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BethanysShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethanysShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BethanysShop.Models.OrderDetail", b =>
                {
                    b.HasOne("BethanysShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanysShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BethanysShop.Models.Pie", b =>
                {
                    b.HasOne("BethanysShop.Models.Category", "Category")
                        .WithMany("Pies")
